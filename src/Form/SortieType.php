    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('dateHeureDebut', DateTimeType::class,
                ['label'=>'Date et heure de la sortie', 'widget'=>'single_text', 'data'=>new \DateTime('+72 hours')])
            ->add('dateLimiteInscription', DateTimeType::class,
                ['label'=>'Date limite d\'inscription', 'widget'=>'single_text', 'data'=>new \DateTime('+48 hours')])
            ...
            /*->add('etat', CheckboxType::class, ['label'=>'Publier'])*/
        ;
